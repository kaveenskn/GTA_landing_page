            ...
            <div className="container">
                <div className="referral-content" ref={contentRef}>
                    ...
                    <p style={{ maxWidth: '800px', margin: '0 auto', lineHeight: '1.8', color: "white" }}>
                        Premium coverage, lowest rates. We offer the most affordable and reliable car insurance at INSIDERSRATE.
                        Experience <span className="text-orange">guaranteed lowest prices</span>,
                        <span className="text-orange"> trusted coverage</span>,<span className="text-orange"> fast quotes</span>, and <span className="text-orange">personalized service</span> tailored just for you.
                    </p>
                </div>
            </div>
        </section>
